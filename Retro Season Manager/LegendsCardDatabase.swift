...
enum LegendsCardDatabase {
    static let all: [LegendsCard] = [
        ...
        // MARK: 1990s era depth (era + Common-tier balance pass)
        // The 1990s era and Common tier were both thin (6 and 4 cards
        // respectively) — this batch deepens both at once rather than
        // only adding more marquee 90s stars.
        LegendsCard(id: "keegana-9394", name: "K. Keegana", season: "1993/94", age: 31, era: .nineties,
                    club: "Highbury", nation: "England", position: .rightBack,
                    overall: 71, pace: 78, shooting: 45, passing: 62, dribbling: 58, defending: 68, physical: 66,
                    rarity: .common, specialAbility: "Tireless Overlap",
                    biography: "A full-back who treated every touchline sprint like it was the cup final."),
        LegendsCard(id: "desaille-9697", name: "M. Desaille", season: "1996/97", age: 28, era: .nineties,
                    club: "Old Trafford Reds", nation: "France", position: .centreBack,
                    overall: 87, pace: 70, shooting: 42, passing: 74, dribbling: 60, defending: 91, physical: 88,
                    rarity: .elite, specialAbility: "Commanding Header",
                    biography: "Won every header, timed every tackle, and still had energy to organise the back four."),
        LegendsCard(id: "laudrupo-9293", name: "M. Laudrupo", season: "1992/93", age: 28, era: .nineties,
                    club: "San Siro Nerazzurri", nation: "Denmark", position: .attackingMid,
                    overall: 84, pace: 66, shooting: 76, passing: 88, dribbling: 87, defending: 30, physical: 58,
                    rarity: .rare, specialAbility: "Velvet First Touch",
                    biography: "A touch so soft that defenders often applauded before realising they'd been beaten."),
        LegendsCard(id: "redondao-9697", name: "F. Redondao", season: "1996/97", age: 27, era: .nineties,
                    club: "Bernabéu Whites", nation: "Argentina", position: .holding,
                    overall: 88, pace: 60, shooting: 62, passing: 86, dribbling: 78, defending: 82, physical: 78,
                    rarity: .hero, specialAbility: "Deep-Lying Vision",
                    biography: "Picked passes from deep that turned defence into attack in a single motion."),
        LegendsCard(id: "overmarso-9596", name: "M. Overmarso", season: "1995/96", age: 22, era: .nineties,
                    club: "Amsterdam Godenzonen", nation: "Netherlands", position: .rightWing,
                    overall: 83, pace: 87, shooting: 74, passing: 72, dribbling: 86, defending: 26, physical: 58,
                    rarity: .rare, specialAbility: "Fearless Take-On",
                    biography: "Small, fast, and utterly fearless running at a full-back one-on-one."),
        LegendsCard(id: "petittov-9798", name: "E. Petittov", season: "1997/98", age: 25, era: .nineties,
                    club: "Old Trafford Reds", nation: "France", position: .holding,
                    overall: 72, pace: 64, shooting: 45, passing: 68, dribbling: 60, defending: 70, physical: 72,
                    rarity: .common, specialAbility: "Simple and Effective",
                    biography: "The unglamorous engine-room player every title-winning midfield actually needs."),
        LegendsCard(id: "seedorfino-9798", name: "C. Seedorfino", season: "1997/98", age: 21, era: .nineties,
                    club: "San Siro Rossoneri", nation: "Netherlands", position: .centralMid,
                    overall: 89, pace: 72, shooting: 78, passing: 84, dribbling: 85, defending: 68, physical: 76,
                    rarity: .hero, specialAbility: "Box-to-Box Versatility",
                    biography: "Equally happy breaking up play or arriving late to smash one in from twenty yards."),
        LegendsCard(id: "hagiwara-9394", name: "G. Hagiwara", season: "1993/94", age: 28, era: .nineties,
                    club: "Turin Bianconeri", nation: "Romania", position: .attackingMid,
                    overall: 90, pace: 70, shooting: 82, passing: 88, dribbling: 92, defending: 34, physical: 60,
                    rarity: .legend, specialAbility: "Free-Kick Wizardry",
                    biography: "A free-kick routine so mesmerising that fans left their seats just to watch him line one up."),

        // MARK: Icons era depth
        // Every existing Icons-era card before this batch was a striker
        // or a centre-back — no goalkeeper, midfielder, full-back or
        // winger had an Icon-tier tribute card despite the position
        // existing at Legend tier or below elsewhere in the database.
        LegendsCard(id: "schmeichelo-icon", name: "P. Schmeichelo", season: "Icon", age: 30, era: .icons,
                    club: "Old Trafford Reds", nation: "Denmark", position: .goalkeeper,
                    overall: 93, pace: 52, shooting: 18, passing: 65, dribbling: 42, defending: 40, physical: 92,
                    rarity: .icon, specialAbility: "Commanding Roar",
                    biography: "A goalkeeper whose roar could be heard over eighty thousand fans — and usually was."),
        LegendsCard(id: "vieirama-icon", name: "P. Vieirama", season: "Icon", age: 28, era: .icons,
                    club: "Highbury", nation: "France", position: .holding,
                    overall: 94, pace: 68, shooting: 65, passing: 84, dribbling: 82, defending: 90, physical: 88,
                    rarity: .icon, specialAbility: "Towering Presence",
                    biography: "Stood a head taller than everyone else in midfield, and played like it too."),
        LegendsCard(id: "bestford-icon", name: "G. Bestford", season: "Icon", age: 24, era: .icons,
                    club: "Old Trafford Reds", nation: "Northern Ireland", position: .leftWing,
                    overall: 95, pace: 88, shooting: 84, passing: 80, dribbling: 96, defending: 28, physical: 64,
                    rarity: .icon, specialAbility: "Instinctive Dribbler",
                    biography: "The first name in football before anyone had agreed what a superstar should look like."),
        LegendsCard(id: "carlosao-icon", name: "R. Carlosao", season: "Icon", age: 26, era: .icons,
                    club: "Bernabéu Whites", nation: "Brazil", position: .leftBack,
                    overall: 94, pace: 89, shooting: 78, passing: 82, dribbling: 88, defending: 80, physical: 74,
                    rarity: .icon, specialAbility: "Thunderbolt Free-Kick",
                    biography: "Free-kicks that seemed to bend around the laws of physics, not just the wall."),
        LegendsCard(id: "riveraldo-icon", name: "R. Riveraldo", season: "Icon", age: 27, era: .icons,
                    club: "San Siro Rossoneri", nation: "Brazil", position: .attackingMid,
                    overall: 95, pace: 78, shooting: 88, passing: 88, dribbling: 94, defending: 32, physical: 62,
                    rarity: .icon, specialAbility: "Impossible Curler",
                    biography: "A left foot so gifted it made the impossible angle look like the obvious choice."),
        LegendsCard(id: "matthausen-icon", name: "L. Matthausen", season: "Icon", age: 29, era: .icons,
                    club: "Bavarian Reds", nation: "Germany", position: .centreBack,
                    overall: 93, pace: 68, shooting: 58, passing: 78, dribbling: 66, defending: 94, physical: 86,
                    rarity: .icon, specialAbility: "Sweeper's Instinct",
                    biography: "Marshalled a back line for over a decade and still found time to smash one in from thirty yards."),

        // MARK: Further Common-tier depth
        // Common was the single thinnest rarity tier (4 cards, despite
        // being the most-frequently-pulled) even after the 1990s batch
        // above added two more — these round it out across other eras.
        LegendsCard(id: "hargrevas-0910", name: "O. Hargrevas", season: "2009/10", age: 28, era: .twoThousands,
                    club: "Old Trafford Reds", nation: "England", position: .centralMid,
                    overall: 70, pace: 62, shooting: 50, passing: 66, dribbling: 60, defending: 66, physical: 70,
                    rarity: .common, specialAbility: "Selfless Cover",
                    biography: "Never the most eye-catching name on the team sheet, but always the one covering someone else's mistake."),
        LegendsCard(id: "milnerson-1213", name: "J. Milnerson", season: "2012/13", age: 26, era: .twentyTens,
                    club: "Etihad Blues", nation: "England", position: .rightMid,
                    overall: 71, pace: 74, shooting: 58, passing: 68, dribbling: 66, defending: 55, physical: 68,
                    rarity: .common, specialAbility: "Utility Player",
                    biography: "Whatever position the manager needed filling that week, he'd already worn the shirt before."),
        LegendsCard(id: "vertongan-1516", name: "J. Vertongan", season: "2015/16", age: 28, era: .twentyTens,
                    club: "Stamford Blues", nation: "Belgium", position: .leftBack,
                    overall: 70, pace: 72, shooting: 40, passing: 64, dribbling: 58, defending: 72, physical: 68,
                    rarity: .common, specialAbility: "Calm Positioning",
                    biography: "Calm, positionally perfect, and never once seemed to be in a hurry."),
    ]
}
