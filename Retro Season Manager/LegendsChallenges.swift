...
enum LegendsChallengeDatabase {
    static let all: [LegendsChallenge] = [
        LegendsChallenge(id: "first-win", title: "First Victory", description: "Win your first match.",
                          cadence: .permanent, kind: .winMatches(1), coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 0),
        LegendsChallenge(id: "hat-trick", title: "Hat-trick Hero", description: "Score 3 or more goals in a single match.",
                          cadence: .permanent, kind: .scoreGoalsInOneMatch(3), coinReward: 150 * LegendsBalance.legacyUnitScale, tokenReward: 0),
        LegendsChallenge(id: "clean-sheet", title: "Clean Sheet", description: "Win or draw without conceding a goal.",
                          cadence: .permanent, kind: .cleanSheet, coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "streak-3", title: "On A Roll", description: "Win 3 matches in a row.",
                          cadence: .permanent, kind: .winStreak(3), coinReward: 200 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "streak-5", title: "Unstoppable", description: "Win 5 matches in a row.",
                          cadence: .permanent, kind: .winStreak(5), coinReward: 400 * LegendsBalance.legacyUnitScale, tokenReward: 2),
        LegendsChallenge(id: "one-flag", title: "One Flag", description: "Win a match with at least 6 Starting XI players sharing one nation.",
                          cadence: .permanent, kind: .sameNationXIWin, coinReward: 150 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "one-era", title: "One Era", description: "Win a match with at least 6 Starting XI players sharing one era.",
                          cadence: .permanent, kind: .sameEraXIWin, coinReward: 150 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "club-legends", title: "Historic XI", description: "Win a match with at least 6 Starting XI players sharing one club.",
                          cadence: .permanent, kind: .sameClubXIWin, coinReward: 200 * LegendsBalance.legacyUnitScale, tokenReward: 2),
        LegendsChallenge(id: "promoted", title: "Promotion", description: "Get promoted to a higher division.",
                          cadence: .permanent, kind: .getPromoted, coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 0),
        LegendsChallenge(id: "collector-10", title: "Growing Collection", description: "Own 10 or more cards.",
                          cadence: .permanent, kind: .ownCards(10), coinReward: 0 * LegendsBalance.legacyUnitScale, tokenReward: 1),

        LegendsChallenge(id: "daily-match", title: "Daily Match", description: "Play 1 match today.",
                          cadence: .daily, kind: .playMatchesToday(1), coinReward: 30 * LegendsBalance.legacyUnitScale, tokenReward: 0),
        LegendsChallenge(id: "daily-win", title: "Daily Win", description: "Win 1 match today.",
                          cadence: .daily, kind: .winMatchesToday(1), coinReward: 50 * LegendsBalance.legacyUnitScale, tokenReward: 1),

        LegendsChallenge(id: "weekly-wins", title: "Weekly Winner", description: "Win 3 matches this week.",
                          cadence: .weekly, kind: .winMatchesThisWeek(3), coinReward: 150 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "weekly-goals", title: "Goal Rush", description: "Score 5 goals this week.",
                          cadence: .weekly, kind: .scoreGoalsThisWeek(5), coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 0),
        ...
        LegendsChallenge(id: "giant-killer", title: "Giant Killer", description: "Beat an opponent rated as strong as or stronger than your own team.",
                          cadence: .permanent, kind: .beatStrongerOpponent, coinReward: 200 * LegendsBalance.legacyUnitScale, tokenReward: 2),
        LegendsChallenge(id: "tactical-edge", title: "Tactical Edge", description: "Win a match with an active Assistant set.",
                          cadence: .permanent, kind: .winWithManager, coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "home-advantage", title: "Home Advantage", description: "Win a match with an active Stadium set.",
                          cadence: .permanent, kind: .winWithStadium, coinReward: 100 * LegendsBalance.legacyUnitScale, tokenReward: 1),
        LegendsChallenge(id: "top-flight", title: "Top Flight", description: "Win a match in the World League.",
                          cadence: .permanent, kind: .winInTopDivision, coinReward: 250 * LegendsBalance.legacyUnitScale, tokenReward: 2),
        LegendsChallenge(id: "weekly-giant-killer", title: "Weekly Upset", description: "Beat a stronger-rated opponent this week.",
                          cadence: .weekly, kind: .beatStrongerOpponent, coinReward: 120 * LegendsBalance.legacyUnitScale, tokenReward: 1),
    ]
}
